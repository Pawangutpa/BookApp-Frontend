...
import news5 from '../../assets/news/news-3.png'
...
const news = [
    ...
    {
        "id": 2,
        "title": "greakthrough in AI Technology Announced",
    ...
    {
        "id": 3,
        "title": "gew Space Mission Aims to Explore Distant Galaxies",
    ...
    {
        "id": 4,
        "title": "dtock Markets Reach Record Highs Amid Economic Recovery",
...
const News = () => {
  return (
    <div className='py-16'>
      <h1 className="text-3xl font-semibold px-4 py-2 mb-6">news</h1>
      <Swiper
        slidesPerView={1}
        spaceBetween={30}
        navigation={true}
          ...
          <SwiperSlide  key={i}>
            <div className='flex flex-col sm:flex-row sm:justify-between items-center gap-12'  >
                ...
                <div className='flex-shrink-0'>
                    <img src={item.image} alt="image" className="w-full object-cover "/>
                </div>
            </div>
